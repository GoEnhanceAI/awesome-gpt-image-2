...
[![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![GitHub stars](https://img.shields.io/github/stars/qiufeng/awesome-gpt-image-2?style=social)](#) [![Prompt Count](https://img.shields.io/badge/Prompts-107-brightgreen)](#statistics) [![Categories](https://img.shields.io/badge/Categories-12-blue)](#category-navigation) [![Candidates](https://img.shields.io/badge/Candidates-3-lightgrey)](#)

A curated showcase of GPT Image 2 prompt examples collected from public community posts, with local assets, cleaner categorization, and browsable release views.

## Why this repo

- Keeps prompt examples and preview images together
- Organizes examples into practical browseable categories
- Preserves community references with local image backups
- Offers both GitHub README browsing and a richer local `overview.html`
...
- [Portrait & Photography](#portrait-photography) (31)
- [Cinematic & Film Still](#cinematic-film-still) (2)
- [Poster & Flyer](#poster-flyer) (12)
- [Illustration & Artwork](#illustration-artwork) (7)
- [Typography & Text Layout](#typography-text-layout) (2)
- [Character & Avatar](#character-avatar) (7)
- [UI, App & Dashboard](#ui-app-dashboard) (17)
- [Social Media Screenshot](#social-media-screenshot) (8)
- [Infographic & Diagram](#infographic-diagram) (7)
- [Product & Marketing](#product-marketing) (2)
- [Comparison & Benchmark](#comparison-benchmark) (1)
- [Maps, Cards & Structured Layouts](#maps-cards-structured-layouts) (11)

## Featured Prompts

### No. 1: GPT-Image-2 prompt: please automatically generate a top-tier concept poster / in...
...
| ![](../images/2213036378327550434/3.jpg) | ![](../images/2213036378327550434/4.jpg) |

**Prompt**
```text
generate a top-tier concept poster / infographic-style movie poster centered around {argument name="theme" default="ranking of emperors in Chinese history"}.
...
### No. 2: Please generate a high-design character relationship map poster based on {argume...
![Language-EN](https://img.shields.io/badge/Language-EN-green) ![Multi-Image](https://img.shields.io/badge/Images-Multi-purple) ![Prompt-Detailed](https://img.shields.io/badge/Prompt-Detailed-yellow)
...
| ![](../images/2035783697861618052/3.jpg) | ![](../images/2035783697861618052/4.jpg) |

**Prompt**
```text
generate a high-design character relationship map poster based on {argument name="theme" default="Demon Slayer"}. This image should not be a simple illustration, but a character relationship map that combines information visualization, narrative structure, poster design sense, and stylistic fidelity.
...
### No. 3: Automatically generate a high-aesthetic "Silhouette Universe / Collector's Editi...
![Language-EN](https://img.shields.io/badge/Language-EN-green) ![Multi-Image](https://img.shields.io/badge/Images-Multi-purple) ![Prompt-Detailed](https://img.shields.io/badge/Prompt-Detailed-yellow)
...
| ![](../images/343496065166897240/3.jpg) | ![](../images/343496065166897240/4.jpg) |
...
### No. 4: Please generate a high-quality vertical "Popular Science Encyclopedia Image" bas...
![Language-EN](https://img.shields.io/badge/Language-EN-green) ![Multi-Image](https://img.shields.io/badge/Images-Multi-purple) ![Prompt-Detailed](https://img.shields.io/badge/Prompt-Detailed-yellow)
...
| ![](../images/6206583148603905237/3.jpg) | ![](../images/6206583148603905237/4.jpg) |

**Prompt**
```text
generate a high-quality vertical "Popular Science Encyclopedia Image" based on {argument name="theme" default="animals"}.
...
### No. 5: Generate a Chinese fitness infographic for [topic].
![Language-EN](https://img.shields.io/badge/Language-EN-green) ![Multi-Image](https://img.shields.io/badge/Images-Multi-purple) ![Prompt-Detailed](https://img.shields.io/badge/Prompt-Detailed-yellow)
...
| ![](../images/7844775649859489515/3.jpg) | ![](../images/7844775649859489515/4.jpg) |
...
### No. 6: {"type": "YouTube desktop dark mode UI mockup", "header": {"logo": "YouTube", "s...
![Language-EN](https://img.shields.io/badge/Language-EN-green) ![Multi-Image](https://img.shields.io/badge/Images-Multi-purple) ![Format-JSON](https://img.shields.io/badge/Prompt-JSON-orange) ![Prompt-Detailed](https://img.shields.io/badge/Prompt-Detailed-yellow)
...
| ![](../images/8658208309035695747/3.jpg) |  |
...
31 prompt examples in this category.  
...
Source: [Tweet](https://twitter.com/dihsclusive/status/2045905067845271555)  
Title: **🚨NEW GPT IMAGE 2 UPDATE ‼️**  
**Prompt**
```text
...
Source: [Tweet](https://twitter.com/Tz_2022/status/2045892003775361198)  
Title: **gpt-image-2 的复杂提示词准确性测试**  
**Prompt**
```text
如下：
...
Source: [Tweet](https://x.com/BubbleBrain/status/2045167461147042202)  
Title: **35mm film photography with harsh convenience store fluorescent lighting mixed wi...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/iam_miharbi/status/2045151354679665101)  
Title: **Generate a cinematic minimal portrait of a solitary man standing in an intense o...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/BubbleBrain/status/2045092449803284923)  
Title: **35mm film photography, warm vintage Japanese onsen ryokan aesthetic, soft ambien...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/BubbleBrain/status/2045052982728016131)  
Title: **35mm color film photography with harsh direct on-camera flash, specular highligh...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/Shinning1010/status/2045002808903020962)  
Title: **A stunning 18-year-old Chinese girl with a youthful, pure face and realistic ski...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/BubbleBrain/status/2046115431144902732)  
Title: **Analog 35mm film photography, soft airy Japanese-style aesthetic, gentle diffuse...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/BubbleBrain/status/2046151898621993364)  
Title: **9:16 vertical — a 3x3 grid collage (nine images) forming a Korean idol portrait ...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/BubbleBrain/status/2046434670724907395)  
Title: **9:16 vertical — editorial portrait, single subject soft black mist filter, subtl...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/BubbleBrain/status/2046483268019884384)  
Title: **9:16 vertical — Japanese Fuji film style portrait, single subject Fujifilm analo...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/BubbleBrain/status/2046518189509734903)  
Title: **9:16 vertical — Korean idol portrait photography, single subject soft black mist...**  
**Prompt**
```text
...
_More in [docs/portrait-photography.md](docs/portrait-photography.md)._

## Cinematic & Film Still

2 prompt examples in this category.  
...
Source: [Tweet](https://twitter.com/xpg0970/status/2045560665071579160)  
Title: **GPT-image 2 完美胜任这种3D立体远透视文字效果**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/A9Quant/status/2046224777208361126)  
...
12 prompt examples in this category.  
...
Source: [Tweet](https://twitter.com/liyue_ai/status/2045873940883808523)  
Title: **gpt image 2生成城市印象创意海报。**  
**Prompt**
```text
【背景与骨架线条】
...
Source: [Tweet](https://twitter.com/liyue_ai/status/2045527750606487877)  
Title: **gpt image 2生成城市剪纸艺术海报。**  
**Prompt**
```text
...
Source: [Tweet](https://twitter.com/liyue_ai/status/2045506567735558336)  
Title: **gpt image 2生成东风美学海报：穷奇。**  
**Prompt**
```text
...
Source: [Tweet](https://twitter.com/MrLarus/status/2045504669401653414)  
Title: **GPT-image-2 生成汉服拆解图🤯图鉴式风格，拆的很细！**  
**Prompt**
```text
...
Source: [Tweet](https://twitter.com/alanlovelq/status/2045484598487060917)  
Title: **GPT image 2生成城市宣传海报。效果也太惊艳了吧！**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/liyue_ai/status/2046215276249993720)  
Title: **新中式水墨山水海报，竖版9:16构图，东方极简美学风格，大面积留白，主题是春岚一叶红。**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/MrLarus/status/2045504669401653414)  
Title: **请根据【主题】自动生成一张“博物馆图鉴式中文拆解信息图”。**  
**Prompt**
```text
要求整张图兼具真实写实主视觉、结构拆解、中文标注、材质说明、纹样寓意、色彩含义和核心特征总结。你需要根据【主题】自动判断最合适的主体对象、服饰体系、器物结构、时代风格、关键部件、材质工艺、颜色方案与版式结构，用户无需再提供其他信息。
若主题适合人物展示，则以真实人物全身站姿为中央主体；若更适合器物或单体结构，则改为中心主体拆解图，但整体仍保持完整中文信息图形式。所有文字必须为简体中文，清晰、规整、可读，不要乱码、错字、英文或拼音。重点突出真实结构、材质差异、文化说明与图鉴气质。
...
Source: [Tweet](https://x.com/MrLarus/status/2045418028733538620)  
Title: **请根据【主题：xxx】自动生成一张高审美的“轮廓宇宙 / 收藏版叙事海报”风格作品。不要将画面局限于固定器物或常见容器，不要优先默认瓶子、沙漏、玻璃罩、怀表之类...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/icreatelife/status/2046639884421550482)  
Title: **Create a "Where is [Your Name]" crowd search poster set in the city of your choo...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/akokoi1/status/2046558658096738672)  
Title: **Generate a 1980s propaganda poster. Use the exact slogan "热烈庆祝GPT-Image-2全量开放". ...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/A9Quant/status/2046228485841334559)  
Title: **GPT-Image-2 prompt: please automatically generate a top-tier concept poster / in...**  
**Prompt**
```text
generate a top-tier concept poster / infographic-style movie poster centered around {argument name="theme" default="ranking of emperors in Chinese history"}.
...
7 prompt examples in this category.  
...
Source: [Tweet](https://twitter.com/liyue_ai/status/2045875219307655337)  
Title: **gpt image 2生成创意插画：锦鲤。**  
**Prompt**
```text
...
Source: [Tweet](https://twitter.com/liyue_ai/status/2045744531686166878)  
Title: **gpt image 2生成城市宣传插画。**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/Panda20230902/status/2045396918965285111)  
Title: **一张手绘风格的城市美食地图，以成都为主题。画面以鸟瞰视角的手绘简化城市地图为底，标注主要道路和地标但不追求精确比例而是追求可爱的手绘感。地图上分布着 12 个美...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/blanplan/status/2045190582453350748)  
Title: **以涂鸦速写风表现【一个厉害的AI builder】，整体呈现快速勾勒、自由变形、即兴手绘与草稿式的视觉效果。线条随手、夸张、可粗细不一，略显凌乱但具有节奏和表现...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/ProperPrompter/status/2046534215311970694)  
Title: **Create a single image containing a grid of 100 completely unique pixel art items...**  
**Prompt**
```text
...
| ![](../images/8719357979198722196/3.jpg) |  |

Source: [Tweet](https://x.com/hx831126/status/2046454226080219281#reversed-3)  
Title: **{**  
**Prompt**
```text
...
| ![](../images/2560744784335959023/3.jpg) |  |

Source: [Tweet](https://x.com/xzjken/status/2045414765640786184#reversed-1)  
Title: **Using REFERENCE_0 as the base style and preserving the central chicken illustrat...**  
**Prompt**
```text
create a solid orange rectangular banner featuring a cooking pot icon, the text {argument name="usage instructions" default="用法:把汤料清洗干净放入锅中，加入姜片煮20分钟，后加入鸡肉再煮20分钟即可。"}, and a secondary slogan {argument name="bottom slogan" default="天然好料 滋补好汤"}.
```
...
Source: [Tweet](https://twitter.com/liyue_ai/status/2045772039521542202)  
Title: **gpt image 2生成城市足球超级联赛邀请函海报。**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/liyue_ai/status/2045000106919997637)  
Title: **以眼部特写图片为基础，生成3:4的四屏构图超写实眼部特写，四屏按春夏秋冬上下排序。**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/Zoulinshen/status/2045082518089810073)  
Title: **生成一张竖版手机截图风格的图片，整体比例接近 9:16。画面中心偏上是一位真人 coser，扮演（角色名称）的二次元角色。人物为写实风格，但五官略带动漫感，皮肤...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/venturetwins/status/2046620134933250409)  
Title: **Create an eight-panel manga about GPT-Image-2 launching today**  
**Prompt**
```text
...
Source: [Tweet](https://opennana.com/awesome-prompt-gallery/key-character-relationship-map)  
Title: **Please generate a key character relationship diagram for "XXX".**  
**Prompt**
```text
generate a key character relationship diagram for "XXX".
```

![Language-EN](https://img.shields.io/badge/Language-EN-green)

Source: [Tweet](https://raw.githubusercontent.com/ZeroLu/awesome-gpt-image/main/README.md)  
Title: **Create a 16-panel expression grid of a silver-haired, blue-eyed anime girl. Her ...**  
**Prompt**
```text
...
Source: [Tweet](https://opennana.com/awesome-prompt-gallery/official-character-reference-sheet)  
Title: **Based on this character and background, please create a character reference shee...**  
**Prompt**
```text
create a character reference sheet similar to official setting materials.
...
| ![](../images/389753669336724394/3.jpg) |  |

Source: [Tweet](https://x.com/liyue_ai/status/2045071977279635962)  
Title: **Generate avatars of various emperors from the {argument name="dynasty" default="...**  
**Prompt**
```text
...
| ![](../images/1635289610037751286/3.jpg) |  |

Source: [Tweet](https://x.com/wtry1102/status/2045281877452575125)  
Title: **Create {argument name="items" default="fan goods"} for a standard {argument name...**  
**Prompt**
```text
...
17 prompt examples in this category.  
...
| ![](../images/2045836554451706125/3.jpg) | ![](../images/2045836554451706125/4.jpg) |

Source: [Tweet](https://twitter.com/stark_nico99/status/2045836554451706125)  
Title: **GPT image 2简直是绝佳的设计搭子**  
**Prompt**
```text
...
| ![](../images/2045700163277107473/3.jpg) | ![](../images/2045700163277107473/4.jpg) |

Source: [Tweet](https://twitter.com/ai_hakase_/status/2045700163277107473)  
Title: **【画像生成の常識が崩壊】GPT Image 2でUIデザインからコード実装まで完結！**  
**Prompt**
```text
【画像生成の常識が崩壊】GPT Image 2でUIデザインからコード実装まで完結！
UIデザインからデプロイ可能なコード生成までを一気通貫で実行。開発の常識を覆す革命的な進化です！✨
```
...
Source: [Tweet](https://x.com/austinit/status/2044968740782272596)  
Title: **用这种风格帮我生成一套UI设计系统，包含网页、移动端、卡片、控件、按钮 以及其它**  
**Prompt**
```text
用这种风格帮我生成一套UI设计系统，包含网页、移动端、卡片、控件、按钮 以及其它
```
...
Source: [Tweet](https://x.com/stark_nico99/status/2045836554451706125)  
Title: **用这种风格帮我生成一套UI设计系统，包含网页、移动端、卡片、控件、按钮以及其它。把这套视觉风格作为参考生成网页。我尝试了宇宙、飞行、蝴蝶主题。**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/pfanis/status/2046414546378584558)  
Title: **Generate for me a UI design system with a very cutting-edge, bold, and unique th...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/AZLnfvp/status/2046468976092533180)  
Title: **用未来都市风格生成UI设计系统,灵感来自赛博朋克城市夜景,包含霓虹灯、玻璃建筑反射、高对比光影,配色以紫色、蓝色、粉色霓虹为主,设计网页Dashboard、移动...**  
**Prompt**
```text
...
Source: [Tweet](https://raw.githubusercontent.com/ZeroLu/awesome-gpt-image/main/README.md)  
Title: **Create a high-fidelity Chinese music app player interface screenshot in mobile p...**  
**Prompt**
```text
...
Source: [Tweet](https://raw.githubusercontent.com/ZeroLu/awesome-gpt-image/main/README.md)  
Title: **Create a high-end skincare e-commerce hero poster for "澄光维稳精华" ("Clarifying Stab...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/MrLarus/status/2046627021674168640)  
Title: **Automatically generate a high-aesthetic "Silhouette Universe / Collector's Editi...**  
**Prompt**
```text
generate a high-aesthetic "Silhouette Universe / Collector's Edition Narrative Poster" based on [theme: xxx]. Do not default to common containers such as bottles, hourglasses, glass domes, or pocket watches. Instead, let the AI choose the most symbolic, visually strong, and narratively suitable outer silhouette for the theme. The silhouette can be an artifact, building, gate, tower, archway, dome, stairwell, corridor, statue, profile, eye, hand, skull, wing, mask, mirror, throne, ring, crack, light curtain, shadow, geometric form, spatial cross-section, stage frame, abstract symbol, or any more creative contour that best represents the theme.
...
| ![](../images/7541474732001147822/3.jpg) |  |

Source: [Tweet](https://x.com/MrLarus/status/2046627021674168640)  
Title: **Generate a three-day travel guide image for [city]**  
**Prompt**
```text
...
Source: [Tweet](https://raw.githubusercontent.com/ZeroLu/awesome-gpt-image/main/README.md)  
Title: **Theme: \"77 (cat's name) X KFC\" collaboration poster. Generate a collaboration ...**  
**Prompt**
```text
...
| ![](../images/4160963701186605112/3.jpg) |  |

Source: [Tweet](https://x.com/danieldmai/status/2046170898118435090#reversed-1)  
Title: **Using REFERENCE_0, transform the subject's appearance to a {argument name="style...**  
**Prompt**
```text
make her skin tone slightly paler. Add 2 facial piercings: a septum ring and a nostril stud. Finally, modify her layered necklaces to feature {argument name="necklace pendants" default="an inverted cross and a pentagram"}.
```

_More in [docs/ui-app-dashboard.md](docs/ui-app-dashboard.md)._

## Social Media Screenshot

8 prompt examples in this category.  
...
Source: [Tweet](https://x.com/alanblogsooo/status/2044784762594918516)  
Title: **9:16 的图片比例，生成一张抖音直播的截图，里面是 刘亦菲 在直播，刘亦菲 手里拿着牌子，牌子里写着 今晚直播，欢迎来参亦菲畅聊！**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/Shinning1010/status/2046501587762188535)  
Title: **A 9:16 vertical version, high-detail realistic style Chinese TikTok live screens...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/alanlovelq/status/2046048929490612464)  
...
| ![](../images/9143522233592151584/3.jpg) | ![](../images/9143522233592151584/4.jpg) |

Source: [Tweet](https://x.com/MrLarus/status/2046627021674168640)  
Title: **Generate a GTA 6 gameplay screenshot of [scene description]**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/underwoodxie96/status/2046529342415790275)  
Title: **Help me generate a screenshot of Trump versus Khamenei in the mid lane in League...**  
**Prompt**
```text
generate a screenshot of Trump versus Khamenei in the mid lane in League of Legends
```

![Language-EN](https://img.shields.io/badge/Language-EN-green)

Source: [Tweet](https://raw.githubusercontent.com/ZeroLu/awesome-gpt-image/main/README.md)  
Title: **Generate a screenshot of a TikTok live stream featuring a beautiful woman stream...**  
**Prompt**
```text
...
Source: [Tweet](https://opennana.com/awesome-prompt-gallery/liu-yifei-douyin-live-chat)  
Title: **9:16 aspect ratio, generate a screenshot of a Douyin live stream, inside is Liu ...**  
**Prompt**
```text
generate a screenshot of a Douyin live stream, inside is Liu Yifei live streaming, Liu Yifei is holding a sign in her hand, the sign says Tonight's live stream, welcome to join Yifei for a chat!
```
...
| ![](../images/7612441541437659896/3.jpg) | ![](../images/7612441541437659896/4.jpg) |

Source: [Tweet](https://x.com/MrLarus/status/2046627021674168640)  
Title: **Generate a screenshot of [historical figure name] on [platform name]**  
**Prompt**
```text
...
7 prompt examples in this category.  
[Open doc](docs/infographic-diagram.md)

![Language-EN](https://img.shields.io/badge/Language-EN-green)

Source: [Tweet](https://opennana.com/awesome-prompt-gallery/jingdezhen-blue-white-porcelain-diagram)  
Title: **Generate a detailed explanatory diagram of Jingdezhen blue and white porcelain, ...**  
**Prompt**
```text
...
Source: [Tweet](https://opennana.com/awesome-prompt-gallery/museum-level-chinese-disassembly-infographic)  
Title: **Please automatically generate a "museum catalog-style Chinese disassembly infogr...**  
**Prompt**
```text
generate a "museum catalog-style Chinese disassembly infographic" based on the [Subject].
...
| ![](../images/6624088905259376768/3.jpg) | ![](../images/6624088905259376768/4.jpg) |

Source: [Tweet](https://x.com/MrLarus/status/2046627021674168640)  
Title: **Generate a high-design character relationship poster for [theme]. This should no...**  
**Prompt**
```text
...
| ![](../images/4897574108240781553/3.jpg) | ![](../images/4897574108240781553/4.jpg) |

Source: [Tweet](https://x.com/yammamon/status/2045778624092254603)  
Title: **Create an explanatory slide ({argument name="format" default="ponchi-e diagram"}...**  
**Prompt**
```text
...
| ![](../images/9014604558516017967/3.jpg) |  |

Source: [Tweet](https://x.com/Kurt_Rousey466/status/2046267707881029934)  
Title: **Help me create a detailed production flowchart for the dish {argument name="dish...**  
**Prompt**
```text
create a detailed production flowchart for the dish {argument name="dish name" default="Fried Pork with Chili"}, in a realistic style, suitable for Xiaohongshu image-text proportions.
```
...
| ![](../images/9207552825478190056/3.jpg) |  |

Source: [Tweet](https://x.com/hx831126/status/2046448092871041500#reversed-2)  
Title: **{**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/MrLarus/status/2046263153546174935)  
Title: **Please generate a high-design character relationship map poster based on {argume...**  
**Prompt**
```text
generate a high-design character relationship map poster based on {argument name="theme" default="Demon Slayer"}. This image should not be a simple illustration, but a character relationship map that combines information visualization, narrative structure, poster design sense, and stylistic fidelity.
...
2 prompt examples in this category.  
[Open doc](docs/product-marketing.md)

![Language-EN](https://img.shields.io/badge/Language-EN-green)

Source: [Tweet](https://opennana.com/awesome-prompt-gallery/terminator-taobao-page)  
...
| ![](../images/2792027281911673836/3.jpg) | ![](../images/2792027281911673836/4.jpg) |

Source: [Tweet](https://x.com/MrLarus/status/2046627021674168640)  
Title: **Generate an e-commerce product detail page for [product name]**  
**Prompt**
```text
...
1 prompt examples in this category.  
...
Source: [Tweet](https://twitter.com/MANISH1027512/status/2045743158860878312)  
Title: **MJ v8.1 vs GPT Image 2**  
**Prompt**
```text
...
## Maps, Cards & Structured Layouts

11 prompt examples in this category.  
...
Source: [Tweet](https://twitter.com/Malek1173989/status/2045836887684694395)  
Title: **Is this gpt image 2?**  
**Prompt**
```text
...
Source: [Tweet](https://raw.githubusercontent.com/ZeroLu/awesome-gpt-image/main/README.md)  
Title: **Generate a high-fidelity mobile e-commerce app homepage screenshot inspired by m...**  
**Prompt**
```text
...
Source: [Tweet](https://opennana.com/awesome-prompt-gallery/custom-style-ui-system)  
Title: **Generate a UI design system for me in xx style, including web pages, mobile, car...**  
**Prompt**
```text
...
Source: [Tweet](https://raw.githubusercontent.com/ZeroLu/awesome-gpt-image/main/README.md)  
Title: **Create a Chinese infographic poster themed "一杯咖啡 如何来到你手里" ("How a Cup of Coffee ...**  
**Prompt**
```text
...
| ![](../images/1227944273825620066/3.jpg) | ![](../images/1227944273825620066/4.jpg) |

Source: [Tweet](https://x.com/MrLarus/status/2046627021674168640)  
Title: **Generate a high-quality vertical encyclopedia-style infographic for [topic].**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/umesh_ai/status/2046510988367945983)  
Title: **Create an image with a 10x10 grid of objects whose names all start with the lett...**  
**Prompt**
```text
...
Source: [Tweet](https://x.com/MrLarus/status/2046627021674168640)  
Title: **Generate a Chinese fitness infographic for [topic].**  
**Prompt**
```text
Generate a Chinese fitness infographic for [topic].
...
Source: [Tweet](https://x.com/alanlovelq/status/2046378199681257920)  
Title: **Please generate a high-quality vertical "Popular Science Encyclopedia Image" bas...**  
**Prompt**
```text
generate a high-quality vertical "Popular Science Encyclopedia Image" based on {argument name="theme" default="animals"}.
...
| ![](../images/459396360438184052/3.jpg) |  |

Source: [Tweet](https://x.com/maxescu/status/2045036186734039545)  
Title: **Search the web for {argument name="performance description" default="this week’s...**  
**Prompt**
```text
generate a {argument name="card type" default="Highlight card"}.
```
...
Source: [Tweet](https://x.com/songguoxiansen/status/2046476566537080849)  
Title: **Generate a 12-grid card image of the 12 Golden Saints from Saint Seiya, with eac...**  
**Prompt**
```text
...
| ![](../images/1735419791910403431/3.jpg) |  |

Source: [Tweet](https://x.com/IndieDevHailey/status/2044974254769463312#reversed-0)  
Title: **{**  
**Prompt**
```text
